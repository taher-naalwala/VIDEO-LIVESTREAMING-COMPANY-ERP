                                    ...
                                    <div class="day-5 days" style="display: block;">
                                        ...
                                        <div id="relay">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 bottom-menu">
                                                ...
                                                <a class="btn btn-default btn-sm active_1" href="https://www.indorejamaat.org/sabaq/online_broadcast_mufaddal_nagar.php?server=a">Server A</a>
                                                <a class="btn btn-default btn-sm active_1" href="https://www.indorejamaat.org/sabaq/online_broadcast_mufaddal_nagar.php?server=b">Server B</a>
                                                <a class="btn btn-default btn-sm active_1" style="background-color:#c9302c;" href="logout_mufaddal_nagar.php">Logout</a>
                    ...
                    <div class="container-fluid mt-2">
                        <div class="row">
                            <div class="alert alert-info text-center mt-2 mr-2 ml-2 mb-2" role="alert">
                                <b>No Ongoing Events Found</b> <a class="btn btn-default btn-sm active_1" style="background-color:#c9302c;" href="logout_mufaddal_nagar.php">Logout</a>
