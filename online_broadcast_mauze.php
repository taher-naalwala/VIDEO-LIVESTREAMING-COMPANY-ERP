  ...
  <div id="main-content" class="container-fluid">
    ...
    ?>
                  ...
                  <div class="day-5 days" style="display: block;">
                    ...
                    <div id="relay">
                      ...
                      <div class="col-lg-12 col-md-12 col-xs-12 bottom-menu">
                        ...
                        <a class="btn btn-default btn-sm active_1" href="https://www.indorejamaat.org/sabaq/online_broadcast_mauze.php?server=a">Server A</a>
                        <a class="btn btn-default btn-sm active_1" href="https://www.indorejamaat.org/sabaq/online_broadcast_mauze.php?server=b">Server B</a>
                        <a class="btn btn-default btn-sm active_1" style="background-color:#c9302c;" href="logout_mauze.php">Logout</a>
                        ...
                        ?>
                          ...
                          <div class="container"><iframe class="responsive-iframe" id="kaltura_player_1646022228" src="https://cdnapisec.kaltura.com/p/3349583/sp/334958300/embedIframeJs/uiconf_id/47652243/partner_id/3349583?iframeembed=true&playerId=kaltura_player_1646022228&entry_id=1_9fbsuyer" width="560" height="395" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" frameborder="0"></iframe></div><br>
      ...
      <div class="container-fluid mt-2">
        <div class="row">
          <div class="alert alert-info text-center mt-2 mr-2 ml-2 mb-2" role="alert">
            <b>No Ongoing Events </b><a class="btn btn-default btn-sm active_1" style="background-color:#c9302c;" href="logout_mauze.php">Logout</a>
